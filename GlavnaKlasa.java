...
public class GlavnaKlasa {
	...
	public static void main(String[] args) {
		File infomracije = new File("informacije.txt");
		...
		while(reader.hasNextLine()){
			String naziv = reader.next();
			int cena = reader.next() ;
			int lokacija = reader.next();
			//Nemam pojma da li ce ovo raditi ali ne mogu da kompajliram ne znam zasto
		}
